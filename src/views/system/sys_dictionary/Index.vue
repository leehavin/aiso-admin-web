...
defineOptions({ name: "system_dictionary" });
...
<template>
  <PageContainer>
    ...
    >
      ...
      <!-- table-col -->
      <template #table-col>
        <a-table-column title="分组名称/键" data-index="name" />
        <a-table-column title="值" data-index="value" />
        <a-table-column title="所属分组" data-index="parentName" />
        <a-table-column title="序号" data-index="sort" />
        <a-table-column title="唯一编码" data-index="code" />
